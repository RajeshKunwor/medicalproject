 $(document).ready(function () {
                          var url = $("#prescriptionForm").attr("load-observation-url");  // get the url of the `load_districts` view
                          ...
                          $.ajax({                       // initialize an AJAX request
                            ...
                            success: function(data) {   // `data` is the return of the `load_districts` view function
                              $("#id_observation").html(data);  // replace the contents of the district input with the data that came from the server
                            }
                          });
